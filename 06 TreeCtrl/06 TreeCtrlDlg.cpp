...
// 06 TreeCtrlDlg.cpp: 实现文件
//

#include "pch.h"
#include "framework.h"
#include "06 TreeCtrl.h"
#include "06 TreeCtrlDlg.h"
...
// CMy06TreeCtrlDlg 对话框



CMy06TreeCtrlDlg::CMy06TreeCtrlDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_MY06_TREECTRL_DIALOG, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

void CMy06TreeCtrlDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
	DDX_Control(pDX, IDC_TREE1, m_Tree);
}

BEGIN_MESSAGE_MAP(CMy06TreeCtrlDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(TVN_SELCHANGED, IDC_TREE1, &CMy06TreeCtrlDlg::OnTvnSelchangedTree1)
END_MESSAGE_MAP()


// CMy06TreeCtrlDlg 消息处理程序
...
BOOL CMy06TreeCtrlDlg::OnInitDialog()
{
	...
	// CImageList list;  需要放在 06 CTreeCtrlDlg.h 头文件中，做为成员属性
	// 准备4个图标集合
...
void CMy06TreeCtrlDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//显示。
HCURSOR CMy06TreeCtrlDlg::OnQueryDragIcon()
{
